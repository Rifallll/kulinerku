    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 p-4">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-40 right-32 text-5xl opacity-10 animate-bounce" style={{ animationDelay: '0.5s' }}>🍛</div>
                <div className="absolute bottom-32 left-1/4 text-7xl opacity-10 animate-bounce" style={{ animationDelay: '1s' }}>🍲</div>
                <div className="absolute bottom-20 right-20 text-6xl opacity-10 animate-bounce" style={{ animationDelay: '1.5s' }}>🥘</div>
            </div>

            {/* Main Card with Glassmorphism & Entrance Animation */}
                ...
                <CardHeader className="space-y-1 text-center animate-in slide-in-from-top-4 fade-in duration-500 delay-150">
                    <div className="flex items-center justify-center mb-4">
                        <div className="relative">
                            ...
                            <LogIn className="h-16 w-16 text-primary relative z-10 animate-in zoom-in duration-500 delay-300" />
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2 group">
                            ...
                            <div className="relative">
                                ...
                                >
                                    {showPassword ? (
                                        <EyeOff className="h-4 w-4 transition-transform hover:rotate-12" />
                                    ) : (
                                        <Eye className="h-4 w-4 transition-transform hover:rotate-12" />
                                    )}
                                </button>
                            </div>
                        </div>
